...
const QUESTIONS: TriviaQuestion[] = [
  ...
  { question: 'What is the currency of Japan?', answers: ['Yuan', 'Won', 'Yen', 'Ringgit'], correctIndex: 2, category: 'Geography' },
  { question: 'How many bones in the human body?', answers: ['186', '206', '226', '246'], correctIndex: 1, category: 'Science' },
  { question: 'Which instrument has 88 keys?', answers: ['Organ', 'Piano', 'Accordion', 'Harpsichord'], correctIndex: 1, category: 'Music' },
  { question: 'What is the largest country by area?', answers: ['China', 'USA', 'Canada', 'Russia'], correctIndex: 3, category: 'Geography' },
  { question: 'What color is an emerald?', answers: ['Blue', 'Red', 'Green', 'Purple'], correctIndex: 2, category: 'Science' },
  { question: 'Who was the first man on the Moon?', answers: ['Buzz Aldrin', 'Neil Armstrong', 'John Glenn', 'Yuri Gagarin'], correctIndex: 1, category: 'History' },
  { question: 'What is the chemical symbol for gold?', answers: ['Go', 'Gd', 'Au', 'Ag'], correctIndex: 2, category: 'Science' },
  { question: 'How many players on a soccer team?', answers: ['9', '10', '11', '12'], correctIndex: 2, category: 'Sports' },
  { question: 'Which animal is known as King of the Jungle?', answers: ['Tiger', 'Lion', 'Bear', 'Gorilla'], correctIndex: 1, category: 'Nature' },
  { question: 'What is the freezing point of water in F?', answers: ['0°F', '32°F', '100°F', '212°F'], correctIndex: 1, category: 'Science' },
  { question: 'Which planet is closest to Earth?', answers: ['Mars', 'Venus', 'Mercury', 'Jupiter'], correctIndex: 1, category: 'Space' },
  { question: 'How many days in a leap year?', answers: ['364', '365', '366', '367'], correctIndex: 2, category: 'Math' },
  { question: 'What is sushi traditionally wrapped in?', answers: ['Rice paper', 'Seaweed', 'Lettuce', 'Bamboo'], correctIndex: 1, category: 'Food' },
  { question: 'Which country invented pizza?', answers: ['France', 'Greece', 'Italy', 'Spain'], correctIndex: 2, category: 'Food' },
  { question: 'What is the tallest mountain?', answers: ['K2', 'Kangchenjunga', 'Everest', 'Lhotse'], correctIndex: 2, category: 'Geography' },
  { question: 'How many wings does a bee have?', answers: ['2', '4', '6', '8'], correctIndex: 1, category: 'Nature' },
  { question: 'What gas do we breathe out?', answers: ['Oxygen', 'Nitrogen', 'CO2', 'Hydrogen'], correctIndex: 2, category: 'Science' },
  { question: 'Which blood type is universal donor?', answers: ['A', 'B', 'AB', 'O'], correctIndex: 3, category: 'Science' },
  { question: 'What sport uses a shuttlecock?', answers: ['Tennis', 'Badminton', 'Squash', 'Table Tennis'], correctIndex: 1, category: 'Sports' },
];
